...
public class PaymentController {
	...
	public Payment addPayment(@Valid @RequestBody PaymentDto payment) {
		return this.ipaymentService.addPayment(payment);

}
	@PutMapping("payment")
  	public Payment updatePayment(@RequestBody PaymentDto payment) throws PaymentNotFoundException {
